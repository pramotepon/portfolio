...
// Css
import '../assets/css/screens/animation.css';
        ...
        <div className='my-auto flex items-center lg:flex-row flex-col w-full lg:mt-auto md:mt-48 mt-28'>
          ...
          <div className='flex-auto w-auto lg:w-64 lg:pl-20'>
            <div className='h-full my-auto'>
              <h1 className='text-6xl mt-16 neon-title-animation'>Pramote Phanon</h1>
              <hr className='text-white' />
              <h2 className='text-tertiary text-6xl drop-shadow-title-shadow'>About me</h2>

          ...
          <div className='lg:flex relative mt-16 h-auto items-center'>
            ...
            <div className='project-image grow w-50 h-80 m-3 relative'>
              <div className='absolute left-52 h-full overflow-hidden'>
                <img src={window.location.origin + '/images/projects/new_javascript_zero_to_hero.jpg'} />
              </div>
            </div>
            {/* Project text */}
            <div className='project-text-container grow w-50 h-60 m-3 relative'>
              <div className='project-text-block absolute h-full w-full border-2 border-tertiary lg:right-52 rounded-lg py-2 px-5'>
                <h1 className='text-tertiary'>Pokedex</h1>
                <p className='text-white text-sm'>
                  This web application is skillfully developed using HTML, CSS, and JavaScript, showcasing proficiency in a range of areas such as console_log, code_comment, variables, data types, conditionals, functions, arrays, loops, objects, iterators, DOM manipulation, events, Promises, and API integration from
                  &nbsp; <a href='https://pokeapi.co/' target='blank'><u>https://pokeapi.co/</u></a>
                </p>
                <div className='tech-use mt-auto mb-0'>
                ...
                <div className='text-right text-white link-block'>
                  <a className='ml-3' href='https://github.com/pramotepon/js_zeekercode/tree/main/workshop_checkpoint' target='_BLANK'>
                    <i className="fa-brands fa-github fa-2xl"></i>
                  </a>
                  <a className='ml-3' href='https://www.youtube.com/watch?v=EhH32gfkrKg' target='_BLANK'>
                  <i class="fa-brands fa-youtube fa-2xl"></i>
                  </a>
                  <a className='ml-3' href='https://js-zeekercode-pokedex.vercel.app/' target='_BLANK'>
          ...
          <div className='lg:flex relative mt-16 h-auto items-center'>
            ...
            <div className='project-text-container grow w-50 h-60 m-3 relative'>
              <div className='project-text-block absolute h-full w-full border-2 border-tertiary lg:right-52 rounded-lg py-2 px-5'>
                ...
                <p className='text-white text-sm'>
                  This project is a web application developed using the MERN stack, encompassing MongoDB for the database, Express.js for the backend framework,
